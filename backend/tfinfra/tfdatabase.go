...
type Database struct {
	...
	MaintenanceWindow  *Maintenance `json:"maintenance_window" description:"(Optional) Defines when the automatic maintenance should be performed for the database cluster." validate:"omitempty,dive,required"`
